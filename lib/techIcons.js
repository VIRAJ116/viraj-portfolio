...
const TECH = {
  ...
  ssestreaming: { Icon: TbBolt, color: "#FFB85C" },

  llmintegration: { Icon: TbSparkles, color: "#A78BFA" },
  llm: { Icon: TbSparkles, color: "#A78BFA" },
  promptengineering: { Icon: TbWand, color: "#F472B6" },
  rag: { Icon: TbBooks, color: "#22D3EE" },

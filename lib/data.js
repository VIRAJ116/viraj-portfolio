export const profile = {
  ...
  resumeUrl: "/viraj_mern.pdf",
  // TODO: confirm exact usernames/URLs
  socials: [
    { label: "GitHub", href: "https://github.com/virajraiyani", handle: "@virajraiyani" },
    { label: "LinkedIn", href: "https://linkedin.com/in/viraj-raiyani", handle: "/in/viraj-raiyani" },
    { label: "Email", href: "mailto:virajraiyani162@gmail.com", handle: "virajraiyani162@gmail.com" },
...
export const marqueeTech = [
  "React", "Next.js", "Angular", "JavaScript", "Node.js", "Express",
  "MongoDB", "MySQL", "Drizzle ORM", "Redux Toolkit", "React Query", "Zustand",
  "Tailwind CSS", "SCSS", "D3.js", "Axios", "Razorpay", "REST APIs",
];
...
export const projects = [
  {
    ...
    description:
      "Production pizza ordering app with JWT cookie auth, role-based access control, Razorpay checkout, and a dynamic-pricing pizza customizer. End-to-end ownership: schema, API, UI, payments.",
    tech: ["React 19", "Node.js", "Express", "MySQL", "Drizzle ORM", "Razorpay"],
    image:
      "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=1600&q=80",
    github: "https://github.com/virajraiyani",
...
export const experience = [
  {
    ...
    location: "Ahmedabad",
    description:
      "Built a network-management app with interactive device-topology visualizations in Next.js, D3.js, and ForeGraph. Engineered an AI chatbot with real-time SSE streaming for low-latency UX. Architected scalable state with Zustand and integrated REST APIs via Axios + React Query.",
    tags: ["Next.js", "D3.js", "Zustand", "React Query", "Tailwind"],
  },
  {
  ...
  },
  {
    ...
    location: "Ahmedabad",
    description:
      "Built feature-rich UIs across Angular, React.js, Tailwind CSS, and SCSS for multiple client products, meeting accessibility and design standards. Integrated REST + GraphQL APIs via Axios and Redux Toolkit. Delivered in an Agile sprint cadence.",
    tags: ["Angular", "React", "GraphQL", "Tailwind", "Agile"],
  },
  {
